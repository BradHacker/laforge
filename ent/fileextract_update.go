...
func (feu *FileExtractUpdate) AppendValidations(s []string) *FileExtractUpdate {
	feu.mutation.AppendValidations(s)
	return feu
}
...
func (feu *FileExtractUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := feu.mutation.Validations(); ok {
		_spec.SetField(fileextract.FieldValidations, field.TypeJSON, value)
	}
	if value, ok := feu.mutation.AppendedValidations(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, fileextract.FieldValidations, value)
		})
	}
...
// AppendValidations appends s to the "validations" field.
func (feuo *FileExtractUpdateOne) AppendValidations(s []string) *FileExtractUpdateOne {
	feuo.mutation.AppendValidations(s)
	return feuo
}
...
func (feuo *FileExtractUpdateOne) sqlSave(ctx context.Context) (_node *FileExtract, err error) {
	...
	if value, ok := feuo.mutation.AppendedValidations(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, fileextract.FieldValidations, value)
		})
	}
