...
func (dru *DNSRecordUpdate) AppendValidations(s []string) *DNSRecordUpdate {
	dru.mutation.AppendValidations(s)
	return dru
}
...
func (dru *DNSRecordUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := dru.mutation.Validations(); ok {
		_spec.SetField(dnsrecord.FieldValidations, field.TypeJSON, value)
	}
	if value, ok := dru.mutation.AppendedValidations(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, dnsrecord.FieldValidations, value)
		})
	}
...
// AppendValidations appends s to the "validations" field.
func (druo *DNSRecordUpdateOne) AppendValidations(s []string) *DNSRecordUpdateOne {
	druo.mutation.AppendValidations(s)
	return druo
}
...
func (druo *DNSRecordUpdateOne) sqlSave(ctx context.Context) (_node *DNSRecord, err error) {
	...
	if value, ok := druo.mutation.AppendedValidations(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, dnsrecord.FieldValidations, value)
		})
	}
