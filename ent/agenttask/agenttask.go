...
// ByValidationField orders the results by Validation field.
func ByValidationField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newValidationStep(), sql.OrderByField(field, opts...))
	}
}
