...
func (e *Environment) Validations(ctx context.Context) (result []*Validation, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = e.NamedValidations(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
...
func (v *Validation) Users(ctx context.Context) (result []*User, err error) {
	if fc := graphql.GetFieldContext(ctx); fc != nil && fc.Field.Alias != "" {
		result, err = v.NamedUsers(graphql.GetFieldContext(ctx).Field.Alias)
	} else {
